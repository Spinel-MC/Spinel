...
pub mod experience_orb {
    use super::*;
    value_definition!(get_value, 8, MetadataValue::VarInt(0));
}
...
pub mod fishing_hook {
    use super::*;
    value_definition!(get_hooked_entity_id, 8, MetadataValue::VarInt(0));
...
pub mod abstract_vehicle {
    ...
    value_definition!(get_shaking_direction, 9, MetadataValue::VarInt(1));
    value_definition!(get_shaking_multiplier, 10, MetadataValue::Float(0.0));
}
...
pub mod boat {
    ...
    value_definition!(get_splash_timer, 13, MetadataValue::VarInt(0));
}
...
pub mod end_crystal {
    use super::*;
    value_definition!(get_beam_target, 8, MetadataValue::OptionalPosition(None));
...
pub mod hanging {
    use super::*;
    value_definition!(get_direction, 8, MetadataValue::Direction(3));
}
...
pub mod item_frame {
    ...
    value_definition!(get_rotation, 10, MetadataValue::VarInt(0));
}

pub mod painting {
    use super::*;
    value_definition!(get_variant, 9, MetadataValue::PaintingVariant(24));
}
...
pub mod primed_tnt {
    use super::*;
    value_definition!(get_fuse_time, 8, MetadataValue::VarInt(80));
    value_definition!(
        get_block_state,
        9,

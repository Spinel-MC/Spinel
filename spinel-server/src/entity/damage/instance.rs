use super::{EntityDamage, EntityProjectileDamage, PositionalDamage};
...
impl Damage {
    ...
    pub fn from_projectile(
        ...
        EntityProjectileDamage::new(shooter, projectile, amount)
    }

    pub fn from_player(player: EntityId, amount: f32) -> EntityDamage {
        EntityDamage::new(player, amount)
    }

    pub fn from_entity(entity: EntityId, amount: f32) -> EntityDamage {
        EntityDamage::new(entity, amount)
    }
    ...
    pub fn from_position(
        ...
        PositionalDamage::new(damage_type, source_position, amount)
    }

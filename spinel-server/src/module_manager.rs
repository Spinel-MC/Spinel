...
use spinel_events::{RegisteredEvent, RegisteredModuleDependency};
...
impl ServerModuleManager {
    pub fn new() -> Self {
        ...
        for module in inventory::iter::<&'static spinel_events::RegisteredServerModule>() {
        ...
        let mut modules_to_resolve: HashSet<&'static str> =
            inventory::iter::<&'static spinel_events::RegisteredServerModule>()
        ...
        active_unqualified_modules.extend(
            inventory::iter::<&'static ServerPacketListener>()
        ...
        // Include modules from RegisteredListeners (event listeners)
        active_unqualified_modules.extend(

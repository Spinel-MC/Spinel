...
pub fn client_module_logic(input: TokenStream) -> TokenStream {
    ...
    for (i, module_lit) in parser.modules.iter().enumerate() {
        ...
        expanded.extend(quote! {
            ...
            static #static_name: spinel::internal::RegisteredClientModule =
                spinel::internal::RegisteredClientModule {
                    name: #module_lit,
                };
            #[cfg(feature = "client")]

...
pub fn generate(
    ...
    ClientPacketListenerGenerator::new(packet_attrs, input_fn, context_type, connection_type)
        .generate()
        .unwrap_or_else(|error| error.to_compile_error())
}

struct ClientPacketListenerGenerator {
    packet_attrs: AttrsParser,
    input_fn: ItemFn,
    context_type: Type,
    connection_type: Type,
...
impl ClientPacketListenerGenerator {
    fn new(
        packet_attrs: AttrsParser,
        input_fn: ItemFn,
        context_type: Type,

...
pub(crate) fn build() -> TokenStream {
    println!(
        "cargo:rerun-if-changed=build_assets/datapacks/default/data/minecraft/worldgen/biome/"
    );

    let biome_dir = "build_assets/datapacks/default/data/minecraft/worldgen/biome";

...
pub(crate) fn build() -> TokenStream {
    println!("cargo:rerun-if-changed=build_assets/datapacks/default/data/minecraft/dialog/");

    let dialog_dir = "build_assets/datapacks/default/data/minecraft/dialog";

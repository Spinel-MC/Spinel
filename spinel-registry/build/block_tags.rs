...
pub(crate) fn build() -> TokenStream {
    println!("cargo:rerun-if-changed=build_assets/datapacks/default/data/minecraft/tags/block/");

    let tag_dir = "build_assets/datapacks/default/data/minecraft/tags/block";
    ...
    for (tag_name, blocks) in &sorted_tags {
        ...
        stream.extend(quote! {
            pub const #tag_ident: &[&str] = &[#(#block_strs),*];
        });
    }

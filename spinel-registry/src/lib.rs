...
pub use registry::{
    ...
    MOB_EFFECT_REGISTRY, PAINTING_VARIANT_REGISTRY, PIG_VARIANT_REGISTRY, POTION_REGISTRY,
    RegisterError, RegisterStaticError, Registries, RegistryCodec, RegistryEntry, RegistryKey,
    RegistrySource, RegistryTag, RegistryTagError, RegistryTags, StaticRegistry, TIMELINE_REGISTRY,
    ...
    vanilla_pig_variants, vanilla_potions, vanilla_timelines, vanilla_trim_materials,
    vanilla_trim_patterns, vanilla_wolf_sound_variants, vanilla_wolf_variants,
...
pub use registry_values::potion::{Potion, PotionEffect};
...
pub mod mob_effect {
    pub use crate::registry_values::mob_effect::*;
}

pub mod potion {
    pub use crate::registry_values::potion::*;
}

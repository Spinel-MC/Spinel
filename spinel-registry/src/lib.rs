...
pub use registry::{
    ...
    MOB_EFFECT_REGISTRY, PAINTING_VARIANT_REGISTRY, POTION_REGISTRY, PIG_VARIANT_REGISTRY, RegisterError,
    RegisterStaticError, Registries, RegistryCodec, RegistryEntry, RegistryKey, RegistrySource,
    RegistryTag, RegistryTagError, RegistryTags, StaticRegistry, TIMELINE_REGISTRY,
    ...
    vanilla_instruments, vanilla_jukebox_songs, vanilla_mob_effects, vanilla_painting_variants, vanilla_potions,

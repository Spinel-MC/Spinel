...
pub use collection::{
    ...
    vanilla_instruments, vanilla_jukebox_songs, vanilla_painting_variants, vanilla_pig_variants,
    vanilla_timelines, vanilla_trim_materials, vanilla_trim_patterns, vanilla_wolf_sound_variants,

...
pub use registries::{
    ...
    MOB_EFFECT_REGISTRY, PAINTING_VARIANT_REGISTRY, PIG_VARIANT_REGISTRY, POTION_REGISTRY, Registries,
...
pub use vanilla::{
    ...
    vanilla_frog_variants, vanilla_instruments, vanilla_jukebox_songs, vanilla_mob_effects,
    vanilla_painting_variants, vanilla_pig_variants, vanilla_potions, vanilla_timelines, vanilla_trim_materials,

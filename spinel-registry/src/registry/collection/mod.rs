...
pub use registries::{
    ...
    Registries, TIMELINE_REGISTRY, TRIM_MATERIAL_REGISTRY, TRIM_PATTERN_REGISTRY,
...
pub use vanilla::{
    ...
    vanilla_painting_variants, vanilla_pig_variants, vanilla_potions, vanilla_timelines,

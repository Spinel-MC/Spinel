...
const CHAT_TYPE_REGISTRY_TAGS: GeneratedTagTable = &[
];

const BIOME_REGISTRY_TAGS: GeneratedTagTable = &[
...
"minecraft:old_growth_birch_forest"
    ...
    ("c:primary_wood_type/cherry", &[
        "minecraft:cherry_grove"
    ]),
    ("c:primary_wood_type/crimson", &[
        "minecraft:crimson_forest"
    ]),
    ("c:primary_wood_type/dark_oak", &[
        "minecraft:dark_forest"
    ]),
...
const DIALOG_REGISTRY_TAGS: GeneratedTagTable = &[
...
const DAMAGE_TYPE_REGISTRY_TAGS: GeneratedTagTable = &[
...
const TRIM_MATERIAL_REGISTRY_TAGS: GeneratedTagTable = &[
];

const TRIM_PATTERN_REGISTRY_TAGS: GeneratedTagTable = &[
];

const BANNER_PATTERN_REGISTRY_TAGS: GeneratedTagTable = &[
...
const ENCHANTMENT_REGISTRY_TAGS: GeneratedTagTable = &[
...
const JUKEBOX_SONG_REGISTRY_TAGS: GeneratedTagTable = &[
];

const INSTRUMENT_REGISTRY_TAGS: GeneratedTagTable = &[
...
const WOLF_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const WOLF_SOUND_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const CAT_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const CHICKEN_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const COW_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const FROG_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const PIG_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const ZOMBIE_NAUTILUS_VARIANT_REGISTRY_TAGS: GeneratedTagTable = &[
];

const TIMELINE_REGISTRY_TAGS: GeneratedTagTable = &[
    ("minecraft:in_end", &[
...
const DIMENSION_TYPE_REGISTRY_TAGS: GeneratedTagTable = &[
];

const BLOCKS_REGISTRY_TAGS: GeneratedTagTable = &[
    ("c:barrels", &[
        "minecraft:barrel"
    ]),
    ("c:barrels/wooden", &[
...
const ITEM_REGISTRY_TAGS: GeneratedTagTable = &[
    ("c:animal_foods", &[
        "minecraft:allium",
"minecraft:apple",
"minecraft:azure_bluet",
...
impl Registries {
    pub fn dynamic_tag_entries(&self) -> Result<Vec<RegistryTags>, RegistryTagError> {
        Ok(vec![
            RegistryTags::new(CHAT_TYPE_REGISTRY, dynamic_registry_tags(&self.chat_types, CHAT_TYPE_REGISTRY, CHAT_TYPE_REGISTRY_TAGS)?),
            RegistryTags::new(BIOME_REGISTRY, dynamic_registry_tags(&self.biomes, BIOME_REGISTRY, BIOME_REGISTRY_TAGS)?),
            RegistryTags::new(DIALOG_REGISTRY, dynamic_registry_tags(&self.dialogs, DIALOG_REGISTRY, DIALOG_REGISTRY_TAGS)?),
            RegistryTags::new(DAMAGE_TYPE_REGISTRY, dynamic_registry_tags(&self.damage_types, DAMAGE_TYPE_REGISTRY, DAMAGE_TYPE_REGISTRY_TAGS)?),
            RegistryTags::new(TRIM_MATERIAL_REGISTRY, dynamic_registry_tags(&self.trim_materials, TRIM_MATERIAL_REGISTRY, TRIM_MATERIAL_REGISTRY_TAGS)?),
            ...
            RegistryTags::new(WOLF_VARIANT_REGISTRY, dynamic_registry_tags(&self.wolf_variants, WOLF_VARIANT_REGISTRY, WOLF_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(WOLF_SOUND_VARIANT_REGISTRY, dynamic_registry_tags(&self.wolf_sound_variants, WOLF_SOUND_VARIANT_REGISTRY, WOLF_SOUND_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(CAT_VARIANT_REGISTRY, dynamic_registry_tags(&self.cat_variants, CAT_VARIANT_REGISTRY, CAT_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(CHICKEN_VARIANT_REGISTRY, dynamic_registry_tags(&self.chicken_variants, CHICKEN_VARIANT_REGISTRY, CHICKEN_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(COW_VARIANT_REGISTRY, dynamic_registry_tags(&self.cow_variants, COW_VARIANT_REGISTRY, COW_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(FROG_VARIANT_REGISTRY, dynamic_registry_tags(&self.frog_variants, FROG_VARIANT_REGISTRY, FROG_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(PIG_VARIANT_REGISTRY, dynamic_registry_tags(&self.pig_variants, PIG_VARIANT_REGISTRY, PIG_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(ZOMBIE_NAUTILUS_VARIANT_REGISTRY, dynamic_registry_tags(&self.zombie_nautilus_variants, ZOMBIE_NAUTILUS_VARIANT_REGISTRY, ZOMBIE_NAUTILUS_VARIANT_REGISTRY_TAGS)?),
            RegistryTags::new(TIMELINE_REGISTRY, dynamic_registry_tags(&self.timelines, TIMELINE_REGISTRY, TIMELINE_REGISTRY_TAGS)?),
            RegistryTags::new(DIMENSION_TYPE_REGISTRY, dynamic_registry_tags(&self.dimension_types, DIMENSION_TYPE_REGISTRY, DIMENSION_TYPE_REGISTRY_TAGS)?),
        ])
    }

    pub fn static_tag_entries(&self) -> Result<Vec<RegistryTags>, RegistryTagError> {
        Ok(vec![
            RegistryTags::new(BLOCKS_REGISTRY, static_registry_tags(&self.blocks, BLOCKS_REGISTRY, BLOCKS_REGISTRY_TAGS)?),
            RegistryTags::new(ITEM_REGISTRY, static_registry_tags(&self.items, ITEM_REGISTRY, ITEM_REGISTRY_TAGS)?),
        ])
    }
}

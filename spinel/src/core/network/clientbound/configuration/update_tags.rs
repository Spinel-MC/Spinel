    ...
    pub fn vanilla_tags() -> Self {
        let registries = vec![
            TagRegistry {
                ...
                tags: vec![
                    Tag {
                        tag_name: "minecraft:mob_interactable_doors".to_string(),
                        entries: vec![
                            207, 614, 615, 616, 617, 619, 620, 858, 859, 621, 622, 618, 1008, 1009,
                            1011, 1010, 1012, 1013, 1015, 1014,
                        ],
                    },
                    Tag {
                        tag_name: "minecraft:campfires".to_string(),
                        entries: vec![818, 819],
                    },
                    Tag {
                        tag_name: "minecraft:soul_fire_base_blocks".to_string(),
                        entries: vec![273, 274],
                    },
                    Tag {
                        tag_name: "minecraft:infiniburn_nether".to_string(),
                        entries: vec![272, 639],
                    },
                    Tag {
                        tag_name: "minecraft:wooden_slabs".to_string(),
                        entries: vec![567, 568, 569, 570, 571, 573, 574, 844, 845, 575, 576, 572],
                    },
                    Tag {
                        tag_name: "minecraft:snaps_goat_horn".to_string(),
                        entries: vec![53, 51, 49, 52, 50, 55, 56, 57, 54, 1, 524, 44, 46, 970, 367],
                    },
                    Tag {
                        tag_name: "minecraft:coal_ores".to_string(),
                        entries: vec![46, 47],
                    },
                    Tag {
                        tag_name: "minecraft:occludes_vibration_signals".to_string(),
                        entries: (140..=155).collect(),
                    },
                    Tag {
                        tag_name: "minecraft:wool".to_string(),
                        entries: (140..=155).collect(),
                    },
                ],
            },
            ...
            TagRegistry {
                ...
                tags: vec![
                    Tag {
                        tag_name: "minecraft:tooltip_order".to_string(),
                        entries: (0..=41).collect(),
                    },
                    Tag {
                        tag_name: "minecraft:double_trade_price".to_string(),
                        entries: vec![2, 40, 37, 35, 14, 22, 41],
                    },
                    Tag {
                        tag_name: "minecraft:treasure".to_string(),
                        entries: vec![2, 40, 37, 35, 14, 22, 41],
                    },
                ],
            },
            TagRegistry {
                ...
                tags: vec![
                    Tag {
                        tag_name: "minecraft:bypasses_armor".to_string(),
                        entries: vec![
                            2, 4, 5, 6, 7, 8, 10, 16, 17, 18, 19, 22, 23, 27, 31, 32, 33, 36, 38,
                            39, 47,
                        ],
                    },
                    Tag {
                        tag_name: "minecraft:is_fire".to_string(),
                        entries: vec![3, 14, 20, 21, 24, 31, 45],
                    },
                ],
            },
            TagRegistry {
                ...
                tags: vec![Tag {
                    tag_name: "minecraft:no_item_required".to_string(),
                    entries: (1..=42)
                        .filter(|&i| ![22, 2, 12, 11, 4, 13, 6, 16, 21, 24].contains(&i))
                        .collect(),
                }],
            },
            TagRegistry {
                ...
                tags: vec![Tag {
                    tag_name: "minecraft:acquirable_job_site".to_string(),
            ...
            TagRegistry {
                ...
                tags: vec![Tag {
                    tag_name: "minecraft:skeletons".to_string(),
                    entries: vec![16, 109, 110, 122, 140],
                }],
            },
            TagRegistry {
                registry_name: "minecraft:instrument".to_string(),
                tags: vec![Tag {
                    tag_name: "minecraft:goat_horns".to_string(),
                    entries: (0..=7).collect(),
                }],
            },
            TagRegistry {
                ...
                tags: vec![Tag {
                    tag_name: "minecraft:vibrations".to_string(),
                    entries: (0..=59).collect(),
                }],
            },
            TagRegistry {
                ...
                tags: vec![
                    Tag {
                        tag_name: "minecraft:lava".to_string(),
                        entries: vec![3, 4],
                    },
                    Tag {
                        tag_name: "minecraft:water".to_string(),
                        entries: vec![1, 2],
                    },
                ],
            },
            ...
            TagRegistry {
                registry_name: "minecraft:item".to_string(),
                tags: vec![],
            },
            TagRegistry {
